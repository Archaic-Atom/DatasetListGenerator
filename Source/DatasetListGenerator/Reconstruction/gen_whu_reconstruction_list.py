...
class WHUReconstructionList(MetaStereoOps):
    TEST_FOLDER = 'test'
    TRAIN_FOLDER = 'train'
    VAL_FOLDER = 'val'
    ...
    def __init__(self, dataset_folder_path: str, save_folder_path: str) -> None:
        ...
        self._training_list = 'whu_reconstruction_training_list.csv'
        self._val_list = 'whu_reconstruction_val_list.csv'
    ...
    def _gen_list(self, root_path: str, save_path: object) -> None:
        ...
        left_img_folder, right_img_folder = self._get_file_folder(root_path)
        ...
        for left_file_name in left_files:
            ...
            if self._check_file_path(left_file_path):
                self.write_file(fd_file, left_file_path)
            if self._check_file_path(right_file_path):
                self.write_file(fd_file, right_file_path)
