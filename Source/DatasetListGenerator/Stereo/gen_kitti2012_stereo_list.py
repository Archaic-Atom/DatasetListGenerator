...
class KITTI2012StereoList(MetaStereoOps):
    ...
    TESTING_IMG_NUM = 194
    TRAINING_IMG_NUM = 195

    def __init__(self, dataset_folder_path: str, save_folder_path: str) -> None:
        super().__init__(dataset_folder_path, save_folder_path)
        self._training_list = 'kitti2012_stereo_training_list.csv'
        self._testing_list = 'kitti2012_stereo_testing_list.csv'
